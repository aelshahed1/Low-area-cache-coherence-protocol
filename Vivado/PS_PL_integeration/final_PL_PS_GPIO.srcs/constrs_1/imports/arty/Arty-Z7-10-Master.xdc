...
create_clock -add -name sys_clk_pin -period 40.00 -waveform {0 20} [get_ports { clk }];#set

# Switches
set_property -dict { PACKAGE_PIN M20  IOSTANDARD LVCMOS33 } [get_ports { enable_zynq }]; #IO_L7N_T1_AD2N_35 Sch=SW0
...
# LEDs
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { program_done }]; #IO_L6N_T0_VREF_34 Sch=LED0
